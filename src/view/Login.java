...
public class Login extends javax.swing.JFrame {
    ...
    PreparedStatement preparedStatement = connection.prepareStatement("select * from user where email = ? and password = ? and role = ?");
    preparedStatement.setString(1, email);
    preparedStatement.setString(2, password);
    preparedStatement.setString(3, accountType.name());
    ...
    if (resultSet.next()) {
        Cookie.selectedUser = new user(
                ...
                "",
                Accounttype.valueOf(resultSet.getString("role"))
        );
        if (Cookie.selectedUser.Accounttype()== Accounttype.Patient) {
